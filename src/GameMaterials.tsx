...
import {IconClockFilled,IconShieldFilled,IconTrophyFilled,IconUserFilled} from '@tabler/icons-react';
...
function MenuBadgeIcon({kind}:{kind:MenuBadge}){
 const props={className:'ro-menu-badge-icon',size:'100%',color:'currentColor','aria-hidden':true};
 if(kind==='players')return <span className="ro-menu-badge-players" aria-hidden="true"><IconUserFilled {...props} size="76%"/><IconUserFilled {...props} size="62%"/></span>;
 const Icon=kind==='trophy'?IconTrophyFilled:kind==='timer'?IconClockFilled:IconShieldFilled;
 return <Icon {...props}/>;
}
