...
const modes=[
 {title:'Grand Prix',detail:'Four courses. One champion.',symbol:'cup',color:'#7daaff'},
 {title:'Multiplayer',detail:'Share the starting grid.',symbol:'kart',color:'#f5c74f'},
 {title:'Time Trial',detail:'Race the clock. Find your perfect lap.',symbol:'coin',color:'#f8c85c'},
 {title:'Battle',detail:'Pick your arena. Defend your balloons.',symbol:'gear',color:'#ec6d95'}
] as const;
